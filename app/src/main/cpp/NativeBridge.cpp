...
using rushtify::audio::AudioEngine;
using rushtify::audio::PcmFormat;
...
Java_com_rushtify_app_playback_NativeAudioEngine_nativeCreate(
    JNIEnv*,
    jobject) {
...
Java_com_rushtify_app_playback_NativeAudioEngine_nativeDestroy(
    JNIEnv*,
    jobject,
    jlong handle) {
...
Java_com_rushtify_app_playback_NativeAudioEngine_nativeStart(
    JNIEnv*,
    jobject,
    jlong handle,
...
extern "C" JNIEXPORT void JNICALL
Java_com_rushtify_app_playback_NativeAudioEngine_nativeStop(
    JNIEnv*,
    jobject,
    jlong handle) {
...
extern "C" JNIEXPORT jboolean JNICALL
Java_com_rushtify_app_playback_NativeAudioEngine_nativeIsRunning(
    JNIEnv*,
    jobject,
    jlong handle) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_rushtify_app_playback_NativeAudioEngine_nativeFlushOutput(
    JNIEnv*,
    jobject,
    jlong handle) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_rushtify_app_playback_NativeAudioEngine_nativeSetPlaying(
    JNIEnv*,
    jobject,
    jlong handle,
    jboolean playing) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_rushtify_app_playback_NativeAudioEngine_nativeSetOutputVolume(
    JNIEnv*,
    jobject,
    jlong handle,
    jfloat volume) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_rushtify_app_playback_NativeAudioEngine_nativeSetStudioMasterClarity(
    JNIEnv*,
    jobject,
    jlong handle,
    jboolean enabled) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_rushtify_app_playback_NativeAudioEngine_nativeSetClarityWet(
    JNIEnv*,
    jobject,
    jlong handle,
    jfloat wet) {
    if (fromHandle(handle) == nullptr) return;
    rushtify::audio::DspProcessor::broadcastClarityWet(wet);
}

extern "C" JNIEXPORT void JNICALL
Java_com_rushtify_app_playback_NativeAudioEngine_nativeSetClarityTrims(
    JNIEnv* env,
    jobject,
    jlong handle,
    jfloatArray trimsDb) {
    if (fromHandle(handle) == nullptr || trimsDb == nullptr ||
        env->GetArrayLength(trimsDb) !=
            static_cast<jsize>(rushtify::audio::DspProcessor::kClarityTrimCount)) {
        return;
    }
    std::array<float, rushtify::audio::DspProcessor::kClarityTrimCount> trims{};
    env->GetFloatArrayRegion(trimsDb, 0, static_cast<jsize>(trims.size()), trims.data());
    if (env->ExceptionCheck()) return;
    rushtify::audio::DspProcessor::broadcastClarityTrims(trims.data(), trims.size());
}

extern "C" JNIEXPORT void JNICALL
Java_com_rushtify_app_playback_NativeAudioEngine_nativeSetClarityPreset(
    JNIEnv*,
    jobject,
    jlong handle,
    jint preset) {
    if (fromHandle(handle) == nullptr) return;
    rushtify::audio::DspProcessor::broadcastClarityPreset(preset);
}

extern "C" JNIEXPORT void JNICALL
Java_com_rushtify_app_playback_NativeAudioEngine_nativeSetClarityAtmosBypass(
    JNIEnv*,
    jobject,
    jlong handle,
    jboolean enabled) {
    if (fromHandle(handle) == nullptr) return;
    rushtify::audio::DspProcessor::broadcastClarityAtmosBypass(enabled == JNI_TRUE);
}

extern "C" JNIEXPORT void JNICALL
Java_com_rushtify_app_playback_NativeAudioEngine_nativeSetBitPerfect(
    JNIEnv*,
    jobject,
    jlong handle,
    jboolean enabled) {
...
extern "C" JNIEXPORT jboolean JNICALL
Java_com_rushtify_app_playback_NativeAudioEngine_nativeIsBitPerfect(
    JNIEnv*,
    jobject,
    jlong handle) {
    const auto* engine = fromHandle(handle);
...
extern "C" JNIEXPORT void JNICALL
Java_com_rushtify_app_playback_NativeAudioEngine_nativeSetEqualizer(
    JNIEnv* env,
    jobject,
    jlong handle,
    jboolean enabled,
    ...
    if (engine == nullptr || gainsDb == nullptr ||
        env->GetArrayLength(gainsDb) !=
            static_cast<jsize>(rushtify::audio::DspProcessor::kEqualizerBandCount)) {
        return;
    }
    std::array<float, rushtify::audio::DspProcessor::kEqualizerBandCount> gains{};
...
extern "C" JNIEXPORT jboolean JNICALL
Java_com_rushtify_app_playback_NativeAudioEngine_nativeConfigureMediaProcessor(
    JNIEnv*,
    jobject,
    jlong handle,
...
Java_com_rushtify_app_playback_NativeAudioEngine_nativeProcessMediaPcm(
    JNIEnv* env,
    jobject,
    jlong handle,
    jobject inputBuffer,
    ...
    const std::size_t inputBytesPerFrame =
        rushtify::audio::PcmConverter::bytesPerSample(format) * channels;
...
extern "C" JNIEXPORT jint JNICALL
Java_com_rushtify_app_playback_NativeAudioEngine_nativeFlushMediaProcessor(
    JNIEnv* env,
    jobject,
    jlong handle,
    jobject outputBuffer,
...
extern "C" JNIEXPORT void JNICALL
Java_com_rushtify_app_playback_NativeAudioEngine_nativeResetMediaProcessor(
    JNIEnv*,
    jobject,
    jlong handle) {
    if (auto* engine = fromHandle(handle); engine != nullptr) {
...
extern "C" JNIEXPORT jint JNICALL
Java_com_rushtify_app_playback_NativeAudioEngine_nativeWritePcm(
    JNIEnv* env,
    jobject,
    jlong handle,
    ...
    const std::size_t bytesPerFrame = rushtify::audio::PcmConverter::bytesPerSample(format) *
...
extern "C" JNIEXPORT jint JNICALL
Java_com_rushtify_app_playback_NativeAudioEngine_nativeWriteProcessedPcm(
    JNIEnv* env,
    jobject,
    jlong handle,
    jobject directBuffer,
...
extern "C" JNIEXPORT void JNICALL
Java_com_rushtify_app_playback_NativeAudioEngine_nativeFlushResampler(
    JNIEnv*,
    jobject,
    jlong handle) {
...
extern "C" JNIEXPORT jint JNICALL
Java_com_rushtify_app_playback_NativeAudioEngine_nativeOutputSampleRate(
    JNIEnv*,
    jobject,
    jlong handle) {
    const auto* engine = fromHandle(handle);
...
extern "C" JNIEXPORT jlong JNICALL
Java_com_rushtify_app_playback_NativeAudioEngine_nativeBufferedFrames(
    JNIEnv*,
    jobject,
    jlong handle) {
    const auto* engine = fromHandle(handle);
...
extern "C" JNIEXPORT jlong JNICALL
Java_com_rushtify_app_playback_NativeAudioEngine_nativeUnderrunCount(
    JNIEnv*,
    jobject,
    jlong handle) {
    const auto* engine = fromHandle(handle);
...
extern "C" JNIEXPORT jlong JNICALL
Java_com_rushtify_app_playback_NativeAudioEngine_nativeRenderedFrames(
    JNIEnv*,
    jobject,
    jlong handle) {
    const auto* engine = fromHandle(handle);
...
extern "C" JNIEXPORT jint JNICALL
Java_com_rushtify_app_playback_NativeAudioEngine_nativeRequestedSampleRate(
    JNIEnv*,
    jobject,
    jlong handle) {
    const auto* engine = fromHandle(handle);
...
extern "C" JNIEXPORT jlong JNICALL
Java_com_rushtify_app_playback_NativeAudioEngine_nativeStreamOpenCount(
    JNIEnv*,
    jobject,
    jlong handle) {
    const auto* engine = fromHandle(handle);
...
extern "C" JNIEXPORT jlong JNICALL
Java_com_rushtify_app_playback_NativeAudioEngine_nativeStreamRestartCount(
    JNIEnv*,
    jobject,
    jlong handle) {
    const auto* engine = fromHandle(handle);
...
extern "C" JNIEXPORT jlong JNICALL
Java_com_rushtify_app_playback_NativeAudioEngine_nativeRateAdaptationCount(
    JNIEnv*,
    jobject,
    jlong handle) {
    const auto* engine = fromHandle(handle);

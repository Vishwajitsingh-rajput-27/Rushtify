...
import com.rushtify.app.data.search.SearchRepository
import com.rushtify.app.data.search.SearchTab
import com.rushtify.app.data.ytmusic.YtMusicLibraryManager
...
class AndroidAutoMediaLibrary @Inject constructor(
    ...
    private fun appIconUri(): Uri = Uri.parse(
        "android.resource://${context.packageName}/${com.rushtify.app.R.drawable.ic_car_attribution}",
    )
    ...
    companion object {
        const val ROOT_ID = "rushtify_root"

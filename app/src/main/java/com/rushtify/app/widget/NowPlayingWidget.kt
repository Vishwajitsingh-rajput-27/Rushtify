...
data class NowPlayingWidgetSnapshot(
    ...
    companion object {
        private const val STORE = "rushtify_widget_now_playing"
...
class NowPlayingWidget : GlanceAppWidget() {
    ...
    override suspend fun provideGlance(context: Context, id: GlanceId) {
        ...
        val darkScheme = themeUiState?.darkColorScheme
            ?: runCatching { com.rushtify.app.ui.theme.Md3SchemeBuilder.buildDarkScheme("#E03030", false) }.getOrNull()
            ?: androidx.compose.material3.darkColorScheme()
        val lightScheme = themeUiState?.lightColorScheme
            ?: runCatching { com.rushtify.app.ui.theme.Md3SchemeBuilder.buildLightScheme("#E03030", false) }.getOrNull()
    ...
    Row(
        modifier = GlanceModifier
            ...
            .then(
                ...
                else GlanceModifier.clickable(actionRunCallback<OpenRushtifyAction>()),
            ),
...
private fun PlayerWidget(state: WidgetUiState) {
    Row(
        modifier = playerSurface(GlanceModifier)
            .clickable(actionRunCallback<OpenRushtifyAction>())

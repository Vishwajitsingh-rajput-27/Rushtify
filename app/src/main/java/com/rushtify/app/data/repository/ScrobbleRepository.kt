...
import com.rushtify.app.data.network.LastFmRateGuard
import com.rushtify.app.data.network.LastFmSigner
...
/**
 * The two signed calls Rushtify's own scrobbler (MediaScrobbleListenerService)
...
class ScrobbleRepository @Inject constructor(
    ...
    /** Mirrors Rushtify's player heart to the authenticated Last.fm library. */

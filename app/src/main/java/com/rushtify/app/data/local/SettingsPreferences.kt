package com.rushtify.app.data.local
...
data class MiscSettings(
     ...
     *  Default "Rushtify" -> Music/Rushtify. Scoped storage (API 29+)
    ...
    /** When true, Settings also shows the advanced sections (audio, scrobbler,
     *  sync, data management). Default off so the screen stays simple for
     *  everyday users — nothing is removed, just tucked away. */
...
enum class HomeSection(val id: String, val titleRes: Int, val subtitleRes: Int) {
    HERO("hero", com.rushtify.app.R.string.home_section_hero_title, com.rushtify.app.R.string.home_section_hero_sub),
    QUICK_TILES("quick_tiles", com.rushtify.app.R.string.home_section_quick_tiles_title, com.rushtify.app.R.string.home_section_quick_tiles_sub),
    TASTE_STRIP("taste_strip", com.rushtify.app.R.string.home_section_taste_strip_title, com.rushtify.app.R.string.home_section_taste_strip_sub),
    QUICK_PICKS("quick_picks", com.rushtify.app.R.string.home_section_quick_picks_title, com.rushtify.app.R.string.home_section_quick_picks_sub),
    BECAUSE_YOU_LISTEN_TO("because_you_listen_to", com.rushtify.app.R.string.home_section_because_title, com.rushtify.app.R.string.home_section_because_sub),
    FRESH_FINDS("fresh_finds", com.rushtify.app.R.string.home_section_fresh_title, com.rushtify.app.R.string.home_section_fresh_sub),
    JUMP_BACK_IN("jump_back_in", com.rushtify.app.R.string.home_section_jump_title, com.rushtify.app.R.string.home_section_jump_sub),
    MIXES("mixed_for_you", com.rushtify.app.R.string.home_section_mixes_title, com.rushtify.app.R.string.home_section_mixes_sub),
    SPOTLIGHT("spotlight_hero", com.rushtify.app.R.string.home_section_spotlight_title, com.rushtify.app.R.string.home_section_spotlight_sub),
    TOP_ARTISTS("top_artists", com.rushtify.app.R.string.home_section_artists_title, com.rushtify.app.R.string.home_section_artists_sub),
    HEAVY_ROTATION("heavy_rotation", com.rushtify.app.R.string.home_section_heavy_title, com.rushtify.app.R.string.home_section_heavy_sub),
    ALBUMS("albums_in_rotation", com.rushtify.app.R.string.home_section_albums_title, com.rushtify.app.R.string.home_section_albums_sub),
    CHARTS("trending_charts", com.rushtify.app.R.string.home_section_charts_title, com.rushtify.app.R.string.home_section_charts_sub),
    NEW_RELEASES("new_releases", com.rushtify.app.R.string.home_section_releases_title, com.rushtify.app.R.string.home_section_releases_sub),
    FRIENDS("friends_activity", com.rushtify.app.R.string.home_section_friends_title, com.rushtify.app.R.string.home_section_friends_sub);
...
enum class DownloadFolderStructure(val id: String, val titleRes: Int, val example: String, val shortLabelRes: Int) {
    FLAT("flat", com.rushtify.app.R.string.dl_struct_flat_title, "Music/<dir>/song.flac", com.rushtify.app.R.string.dl_struct_flat_short),
    ARTIST_ALBUM("artist_album", com.rushtify.app.R.string.dl_struct_artist_album_title, "Artist/Album/", com.rushtify.app.R.string.dl_struct_artist_album_short),
    ARTIST_YEAR_ALBUM("artist_year_album", com.rushtify.app.R.string.dl_struct_artist_year_album_title, "Artist/[2025] Album/", com.rushtify.app.R.string.dl_struct_artist_year_album_short),
    ALBUM_ONLY("album_only", com.rushtify.app.R.string.dl_struct_album_only_title, "Album/", com.rushtify.app.R.string.dl_struct_album_only_short),
    YEAR_ALBUM("year_album", com.rushtify.app.R.string.dl_struct_year_album_title, "[2025] Album/", com.rushtify.app.R.string.dl_struct_year_album_short),
    ARTIST_ALBUM_SINGLES("artist_album_singles", com.rushtify.app.R.string.dl_struct_artist_album_singles_title, "Artist/Album/ and Artist/Singles/", com.rushtify.app.R.string.dl_struct_artist_album_singles_short),
    ARTIST_ALBUM_SINGLES_FLAT("artist_album_singles_flat", com.rushtify.app.R.string.dl_struct_artist_album_singles_flat_title, "Artist/Album/ and Artist/song.flac", com.rushtify.app.R.string.dl_struct_artist_album_singles_flat_short);
...
/** Default subfolder under Music/ for offline tracks (Music/Rushtify). */
const val DEFAULT_DOWNLOAD_FOLDER = "Rushtify"
...
class SettingsPreferences @Inject constructor(
    ...
    private object Keys {
        ...
        val ADVANCED_SETTINGS_ENABLED = booleanPreferencesKey("lw_advanced_settings")
    }
        ...
        .map { p ->
            MiscSettings(
                ...
                hiddenHomeSections = p.readSafely(Keys.HIDDEN_HOME_SECTIONS)
                    ...
                    ?: emptySet(),
                advancedSettingsEnabled = p.readSafely(Keys.ADVANCED_SETTINGS_ENABLED) ?: false,
            )
        }

    suspend fun setAdvancedSettingsEnabled(enabled: Boolean) {
        dataStore.edit { it[Keys.ADVANCED_SETTINGS_ENABLED] = enabled }
    }

package com.rushtify.app.ui.home
...
import com.rushtify.app.ui.common.HeaderActionIcon
...
import com.rushtify.app.ui.theme.BadgePillShape
import com.rushtify.app.ui.theme.ExpressiveHeroShape
import com.rushtify.app.ui.theme.ExpressivePillShape
import com.rushtify.app.ui.theme.HeroInnerShape
import com.rushtify.app.ui.theme.ListContainerShape
import com.rushtify.app.ui.theme.NowPlayingCardShape
import com.rushtify.app.ui.theme.StatPillShape
import com.rushtify.app.ui.theme.TrackRowShape
...
import com.rushtify.app.data.repository.HomeAlbum
import com.rushtify.app.data.repository.HomeArtistItem
import com.rushtify.app.data.repository.HomeSortMode
import com.rushtify.app.data.repository.HomeTrack
...
fun HomeScreen(
    ...
    artistAlbumNavigator: com.rushtify.app.ui.navigation.ArtistAlbumNavigator = hiltViewModel<ArtistAlbumNavBridgeHome>().navigator,
) {
    ...
    Scaffold(
        ...
        if (uiState.isLoading) {
            Box(
                ...
                com.rushtify.app.ui.common.ExpressiveLoadingIndicator(message = "Loading your listening history")
            }
            return@Scaffold
        }
    ...
    menuTrack?.let { track ->
        com.rushtify.app.ui.common.TrackContextMenuSheet(
            target = com.rushtify.app.ui.common.TrackMenuTarget.Track(track.name, track.artist, track.artworkUrl.orEmpty()),
            capabilities = com.rushtify.app.ui.common.TrackMenuCapabilities(showCopyActions = true, showDeleteScrobble = true),
    ...
    Surface(
        ...
        Row(
            ...
            Box(
                ...
                ArtworkImage(
                    name = track.name,
                    artist = com.rushtify.app.util.ArtistHelper.primaryArtist(track.artist),
            ...
            Column(Modifier.weight(1f)) {
                ...
                val displayArtist = com.rushtify.app.util.ArtistHelper.primaryArtist(track.artist)
            ...
            com.rushtify.app.ui.common.OverflowMenuButton(onClick = onMenuClick)
        }
    }
}
    ...
    Surface(
        ...
        Row(
            ...
            Column(Modifier.weight(1f)) {
                ...
                val displayArtist = com.rushtify.app.util.ArtistHelper.primaryArtist(album.artist)
                if (displayArtist.isNotBlank()) {
                    Spacer(Modifier.height(2.dp))
                    Text(
                        displayArtist,

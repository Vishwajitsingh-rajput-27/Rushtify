package com.rushtify.app.ui.navigation
...
import com.rushtify.app.data.model.AuthState
import com.rushtify.app.ui.auth.AuthViewModel
import com.rushtify.app.ui.auth.LoginScreen
import com.rushtify.app.ui.settings.SettingsScreen
import com.rushtify.app.ui.search.SearchScreen
import com.rushtify.app.ui.discover.DiscoverScreen
import com.rushtify.app.ui.genres.GenresScreen
import com.rushtify.app.ui.shell.MainShell
import com.rushtify.app.ui.common.PredictiveBackScreen
import com.rushtify.app.ui.common.ExpressiveLoadingIndicator
import com.rushtify.app.ui.common.ExpressiveMotion
import com.rushtify.app.ui.genres.GenreExplorer
...
/** Thin bridge so RushtifyNavHost (a plain composable, no direct Hilt
...
@HiltViewModel
class MixLauncherNavBridge @Inject constructor(val mixLauncher: com.rushtify.app.ui.generate.MixLauncher) : ViewModel()
...
class LaunchGateViewModel @Inject constructor(
    authRepository: com.rushtify.app.data.repository.AuthRepository,
    sessionPreferences: com.rushtify.app.data.local.SessionPreferences,
    ytAuthManager: com.rushtify.app.data.ytmusic.YtMusicAuthManager,
) : ViewModel() {
    ...
    NavHost(
        ...
        composable(Screen.Login.route) {
            ...
            LaunchedEffect(gateTarget, webAuthState) {
                if (gateTarget == LaunchGateViewModel.GateTarget.MainShell &&
                    webAuthState == com.rushtify.app.ui.auth.WebAuthState.Idle
                ) {
            ...
            val restoreError = (webAuthState as? com.rushtify.app.ui.auth.WebAuthState.Error)?.message
            val restoring = webAuthState == com.rushtify.app.ui.auth.WebAuthState.RestoringBackup
            LoginScreen(
                onLoginWithYouTube = {
        ...
        composable(Screen.MainShell.route) {
            MainShell(
                ...
                onOpenImport = {
                    navController.navigate(Screen.ExternalPlaylistImport.route)
                },
        ...
        composable(Screen.Create.route) {
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.rushtify.app.ui.generate.GenerateScreen(
        ...
        composable(Screen.Friends.route) { backStackEntry ->
            ...
            val homeViewModel: com.rushtify.app.ui.home.HomeViewModel = hiltViewModel(parentEntry)
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.rushtify.app.ui.home.FriendsScreen(
        ...
        composable(
            ...
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.rushtify.app.ui.home.FriendProfileScreen(
                    username = username,
        ...
        composable(Screen.YouTubeImport.route) {
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.rushtify.app.ui.settings.YouTubePlaylistImportScreen(
                    onBack = { navController.popBackStack() },
                    onImportSuccess = {
                        navController.popBackStack()
                    },
        ...
        composable(Screen.YouTubeLogin.route) {
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.rushtify.app.ui.settings.YouTubeLoginScreen(
                    onBack = { navController.popBackStack() },
        ...
        composable(Screen.ExternalPlaylistImport.route) {
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.rushtify.app.ui.settings.ExternalPlaylistImportScreen(
                    onBack = { navController.popBackStack() },
                    onImportSuccess = {
                        navController.popBackStack()
                    },
        ...
        composable(Screen.Downloads.route) {
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.rushtify.app.ui.settings.DownloadsScreen(onBack = { navController.popBackStack() })
            }
        }

        composable(Screen.ProviderModules.route) {
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.rushtify.app.ui.settings.ModulesScreen(onBack = { navController.popBackStack() })
            }
        }

        composable(Screen.HomeSections.route) {
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.rushtify.app.ui.settings.HomeSectionsScreen(onBack = { navController.popBackStack() })
            }
        }

        composable(Screen.ExcludedSongs.route) {
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.rushtify.app.ui.settings.ExcludedSongsScreen(onBack = { navController.popBackStack() })
            }
        }

        composable(Screen.ScrobblerApps.route) {
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.rushtify.app.ui.settings.ScrobblerAppsScreen(onBack = { navController.popBackStack() })
            }
        }
        ...
        composable(Screen.NewReleases.route) {
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.rushtify.app.ui.newreleases.NewReleasesScreen(
                    onBack = { navController.popBackStack() },
                )
            }
        }
        ...
        composable(
            ...
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.rushtify.app.ui.feed.FeedPlaylistDetailScreen(
        ...
        composable(
            ...
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.rushtify.app.ui.playlist.PlaylistDetailScreen(
                    playlistId = playlistId,
                    onBack = { navController.popBackStack() },
        ...
        composable(
            ...
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.rushtify.app.ui.artist.ArtistDetailScreen(
        ...
        composable(
            ...
            val browseId = backStackEntry.arguments?.getString("browseId")?.takeIf(String::isNotBlank)
            PredictiveBackScreen(onBack = { navController.popBackStack() }) {
                com.rushtify.app.ui.album.AlbumDetailScreen(
...
private fun LaunchGate() {
    Box(Modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            // Square brand-badge frame (navy) behind the R-and-arrow mark,
            // mirroring the square logo frame from the logotype sheet.
            Surface(
                shape = RoundedCornerShape(28.dp),
                color = androidx.compose.ui.res.colorResource(com.rushtify.app.R.color.ic_launcher_background),
                shadowElevation = 10.dp,
                modifier = Modifier.size(88.dp),
            ) {
                androidx.compose.foundation.Image(
                    painter = painterResource(com.rushtify.app.R.drawable.ic_launcher_foreground),
                    contentDescription = null,
                    modifier = Modifier.fillMaxSize(),
                )
            }
            Spacer(Modifier.height(18.dp))
            Text("Rushtify", style = MaterialTheme.typography.headlineSmall)

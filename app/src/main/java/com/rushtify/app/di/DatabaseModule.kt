package com.rushtify.app.di

import android.content.Context
import androidx.room.Room
import androidx.room.migration.Migration
import com.rushtify.app.data.local.db.AppDatabase
import com.rushtify.app.data.local.db.ArtworkCacheDao
...
object DatabaseModule {
    ...
    fun provideAppDatabase(@ApplicationContext context: Context): AppDatabase =
        Room.databaseBuilder(context, AppDatabase::class.java, "rushtify.db")
    ...
    @Provides
    @Singleton
    fun provideDownloadedTrackDao(database: AppDatabase): com.rushtify.app.data.local.db.DownloadedTrackDao =
        database.downloadedTrackDao()

    @Provides
    @Singleton
    fun provideSongPlayStatsDao(database: AppDatabase): com.rushtify.app.data.local.db.SongPlayStatsDao =

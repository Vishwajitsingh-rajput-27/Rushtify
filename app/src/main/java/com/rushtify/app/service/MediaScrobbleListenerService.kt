package com.rushtify.app.service
...
/**
 * Rushtify's own local scrobbler, built after the reference Pano-Scrobbler
...
class MediaScrobbleListenerService : NotificationListenerService() {
    ...
    /** The track key (artist|title) Rushtify most recently told Last.fm is

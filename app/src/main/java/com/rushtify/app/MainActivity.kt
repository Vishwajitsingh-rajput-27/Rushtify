...
import com.rushtify.app.util.AppLocaleManager
...
import com.rushtify.app.ui.theme.RushtifyTheme
import com.rushtify.app.ui.theme.ThemeViewModel
...
class MainActivity : androidx.fragment.app.FragmentActivity() {
    ...
    @Inject
    lateinit var appRouteNavigator: dagger.Lazy<com.rushtify.app.ui.navigation.AppRouteNavigator>

    @Inject
    lateinit var settingsPreferences: com.rushtify.app.data.local.SettingsPreferences
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            RushtifyTheme(themeState = themeState) {
            ...
            runCatching {
                ...
                if (hasAccess) {
                    android.service.notification.NotificationListenerService.requestRebind(
                        android.content.ComponentName(this, com.rushtify.app.service.MediaScrobbleListenerService::class.java),
                    )
                }
            }
        }
    ...
    private fun handlePlaybackIntent(intent: Intent?) {
        if (intent?.action == android.provider.MediaStore.INTENT_ACTION_MEDIA_PLAY_FROM_SEARCH) {
            val playbackIntent = Intent(this, com.rushtify.app.playback.MusicPlaybackService::class.java)
    ...
    private fun handleNavigationIntent(intent: Intent?) {
        ...
        val isDownloadsTarget = intent.action == com.rushtify.app.data.download.TrackDownloadManager.ACTION_VIEW_DOWNLOADS ||
            intent.getStringExtra(com.rushtify.app.data.download.TrackDownloadManager.EXTRA_NAVIGATE_TO) == Screen.Downloads.route
    ...
    private companion object {
        const val STARTUP_TAG = "RushtifyStartup"
    }
}
